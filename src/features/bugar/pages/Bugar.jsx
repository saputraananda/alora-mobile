...
import BugarLeaderboard from '../components/BugarLeaderboard.jsx';
import BugarHaidCard from '../components/BugarHaidCard.jsx';
import BugarHaidStartModal from '../components/BugarHaidStartModal.jsx';
import BugarHaidFollowUpModal from '../components/BugarHaidFollowUpModal.jsx';
    ...
    <div className="flex flex-col w-full min-h-screen bg-slate-50 pb-28">
      <header className="relative pt-5 pb-5 px-5 bg-[#050B14] rounded-b-[36px] overflow-hidden shadow-xl text-white flex-shrink-0">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <PageHeaderRefreshButton onRefresh={reload} />
        </div>
      </header>
