        ...
        <div className="px-5 py-2.5 border-b border-slate-100/80 last:border-b-0">
            ...
            {options ? (
                ...
                <input
                    ...
                    className={
                        type === 'date'
                            ? `w-full min-w-0 max-w-full border rounded-xl px-3 py-2.5 text-[13px] text-navy-950 focus:outline-none focus:ring-2 ${error ? 'border-red-400 focus:ring-red-200' : 'border-slate-200 focus:ring-navy-950/20 focus:border-navy-950'}`
                            : `w-full text-[13px] font-bold text-navy-950 bg-slate-50 border rounded-[12px] px-3 h-[40px] focus:outline-none focus:ring-2 transition placeholder:text-slate-300 ${error ? 'border-red-400 focus:ring-red-200' : 'border-slate-200 focus:ring-navy-950/20 focus:border-navy-950'}`
                    }
                />
            )}
        ...
        <div className="flex flex-col w-full min-h-screen bg-slate-50 pb-28">
            ...
            <header className="relative pt-5 pb-8 px-5 bg-[#050B14] rounded-b-[36px] overflow-hidden shadow-xl text-white">
                ...
                <div className="relative z-20 flex flex-col items-center mt-2 gap-1.5">
                    ...
                    <h2 className="text-[16px] font-black text-white leading-tight">{name || 'Pegawai Alora'}</h2>
